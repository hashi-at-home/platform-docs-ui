...
[.lead]
You are looking at the preview site for the Antora default UI.
...
We can use fontawesome icon:poo-storm[] for fast performance

=== Devicons (v2.17.0)

We can also use devicons with many new icons added in v2.17.0. Some examples:

*Programming Languages:* icon:devicon-python[] Python, icon:devicon-javascript[] JavaScript, icon:devicon-typescript[] TypeScript, icon:devicon-rust[] Rust, icon:devicon-go[] Go

*Frameworks:* icon:devicon-react[] React, icon:devicon-vuejs[] Vue.js, icon:devicon-angular[] Angular, icon:devicon-nextjs[] Next.js

*Infrastructure:* icon:devicon-docker[] Docker, icon:devicon-kubernetes[] Kubernetes, icon:devicon-terraform[] Terraform, icon:devicon-nginx[] Nginx

*Databases:* icon:devicon-postgresql[] PostgreSQL, icon:devicon-mysql[] MySQL, icon:devicon-mongodb[] MongoDB, icon:devicon-redis[] Redis

*DevOps & Tools:* icon:devicon-github[] GitHub, icon:devicon-gitlab[] GitLab, icon:devicon-jenkins[] Jenkins, icon:devicon-git[] Git

icon:devicon-confluence[] Confluence

normal confluence: icon:confluence[] icon:zap[]

maybe plural ? icon:devicons-confluence[]
